    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/file_uploader_html5.jsp'; 	//upload URL'; 	//upload URL
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/file_uploader',	//샘플 켠트롤러입니다.
 		        sCallback : '/resource/inc/ne/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
