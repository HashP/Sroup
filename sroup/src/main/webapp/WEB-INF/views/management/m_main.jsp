		...
		<c:forEach var="noticeList" items="${noticeList }">
			<div id="notice-${noticeList.n_no}" class="notice">
				...
				<h2 class="page-header">
					...
					<a href="#del();" id="${noticeList.n_no}" class="btn btn-default del-btn"	style="float: right; margin-top: 10px">
					<span class="glyphicon glyphicon-remove"></span></a> 
					
					<a href="#"  class="btn btn-default" style="float: right; margin-top: 10px">
					<span class="glyphicon glyphicon-ok"></span></a>
					
					<a href="notice_write.do" class="btn btn-default" style="float: right; margin-top: 10px">
